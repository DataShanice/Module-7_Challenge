...
-- Retirment eligibility creating new table to hold info 
SELECT  emp_no, first_name, last_name
INTO retirement_info 
FROM employees 
WHERE (birth_date BETWEEN '1925-01-01' AND '1995-12-31')
AND (hire_date BETWEEN '1995-01-01' AND '1998-12-31');
...
-- Employee list with gender and salaries 
SELECT e.emp_no,
e.first_name,
s.salary,
de.to_date
...
-- List Empployees with departments 
SELECT ce.emp_no,
	ce.last_name,
	ce.first_name,
	d.dept_name
